...
import { Container, Header, Content, Thumbnail,Left, Body, Right, Button, Spinner,ListItem, Card,CardItem, List} from 'native-base';
import PageFooter from './PageFooter'
import { TouchableOpacity, Text,AsyncStorage,FlatList, ActivityIndicator, View,ScrollView ,Icon,Image } from 'react-native';
...
export default class AllPlaces extends React.Component {
    ...
    componentDidMount(){
      return fetch('http://reactnative.website/iti/wp-json/wp/v2/posts?categories=2')
              ...
              return(
                ...
                <List>
                  ...
                  <TouchableOpacity onPress={() =>{
                     ...
                     <Body style={{flex:0,alignSelf:'center',flex: 1,}}>
